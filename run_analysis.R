#
# This is the source file for the Coursera course "Getting and Cleaning Data"
...
#
# and was unzipped into the current directory.  All file paths will be relative references
...
#
# First we will need to read in the Training and Test data sets.  Both sets of data are split
# into 3 files: subject, activity and features.  6 files in all.
#
...
#
# Now we can perform step 1 of the course instructions, merging the testing and
# training data sets into 3 combined data sets for Subject, Activity and Features
#
...
#
# Before we move on, it will make things easier if we set the columns from the description
# file features.txt.  We will also set names for the activity and subject data
#
...
#
# Now we can perform Step 2 of the course instructions, trimming the data
# set down to just the Mean and Std Deviation columns (plus the activity
# and subject)
#
